...
<div class="tab-frame " id="start_tab">
        ...
        <div class="layui-layim">
            ...
            <div class="layim-tab-content layui-show">
                <ul class="layim-list-top">
                    ...
                    <#--</li>-->
                    <li id=che_dan winTitle="全民尬聊"><i class="layui-icon"></i>全民尬聊<i class="layim-new"
    ...
    <div class="zwim-tab-page hide" index="2">
        <div class="layui-layim">
            ...
            <div class="layim-tab-content layui-show">
                <ul class="layim-list-top">
                    <li lay-filter="find"><i class="layui-icon "></i>全民坦克(构思中)<i class="layim-new layui-show"
                                                                                  id="LAY_layimNewfind"></i>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <ul class="zwim-tab" style="overflow-x: hidden;overflow-y: auto;display: flex">
        <li title="消息" index=0 class="zwim-this"><i class="zwim-icon "></i><span>消息</span><i
                    class="layim-new layui-show"
                    id="LAY_layimNewMsg"></i></li>
        <li title="去聊天" index=1><i class="zwim-icon"></i><span>去聊天</span><i class="layim-new"
                                                                             id="LAY_layimNewList"></i>
        </li>
...
<script id="quan_min_ga_liao_temp" type="text/html">
    <div style="    position: absolute;top: 0px;right: 46px;color: #fff;font-size: 15px;height: 50px;line-height: 50px;">
        <span>当前在线人数:<span style="font-size: 20px" id="lineNumPeople"></span>人</span></div>
...
<script>
    ...
    function closeWin() {
        ...
        setTimeout(function () {
            $('#' + winData.newWinId).remove();
        }, 1000);//延迟关闭窗口,为了特效显示平滑处理,
...
<script>
    ...
    $(document).on('click', '.sendbtn', function () {
        ...
        var user = g_appuser || getuserInfo();
        //发送,groupId为1是全服
        send(encode('quan_min_ga_liao', {
            groupId: 1,
            content: $('.layim-chat-send input').val(),
            head: user.head,
